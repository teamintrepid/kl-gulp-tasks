...
module.exports = function (options) {
  ...
  var watchSource = options.watchLinkedModules ? linkedModulesWatch() : [];
  watchSource.push(source);
  var typings = 'typings/index.d.ts';
  var customTypings = 'custom_typings/**/*.d.ts';
  var dest = 'lib';
  var destGlob = dest + '/**/*.*';
  var watchDest = options.watchLinkedModules ? linkedModulesWatch() : [];
  watchDest.push(destGlob);
  ...
  gulp.task('ts-run', function (callback) {
    sequence('ts-compile', 'ts-watch-compile', 'start')(callback);
  });
  gulp.task('js-run', function (callback) {
    sequence('js-compile', 'js-watch-compile', 'start')(callback);
  });
};
